...
import { useMountedState, useLocale, useFilesystem } from 'hooks';
                                ...
                                <View style={tailwind('flex flex-row')}>
                                    <View style={tailwind('flex flex-row items-center flex-1 mb-3')}>
                                        <View style={tailwind('mr-3')}>
                                            <FastImage source={{ uri: getUrl(review.getAttribute('customer.photo_url')) }} style={tailwind('bg-gray-300 rounded-full w-10 h-10')} />
                                        </View>
                                ...
                                <View style={tailwind(`flex flex-row flex-wrap ${review.getAttribute('photos') ? 'mt-4' : ''}`)}>
                                    {review.getAttribute('photos')?.map((photo, index) => (
                                        <View key={index} style={tailwind('mr-2 mb-2')}>
                                            <FastImage source={{ uri: getUrl(photo.url )}} style={tailwind('w-24 h-24 z-10')} />
                                        </View>
                                    ))}
                                </View>
                            </View>
