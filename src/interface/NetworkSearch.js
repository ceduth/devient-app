...
import { useStorefront, useLocale, useMountedState, useStorage, useFilesystem } from 'hooks';
                                    ...
                                    <View style={tailwind('flex flex-row')}>
                                        <View style={tailwind('mr-3')}>
                                            <View style={tailwind('border border-gray-200 shadow-sm')}>
                                                <Image source={{ uri: getUrl(product.getAttribute('primary_image_url')) }} style={tailwind('h-14 w-14')} />
                                            </View>
                                        </View>
