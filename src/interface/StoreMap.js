                ...
                <View style={tailwind('p-4')}>
                    <View style={tailwind('flex flex-row')}>
                        <View style={tailwind('mr-4')}>
                            <FastImage source={{ uri: getUrl(item.getAttribute('store.logo_url')) }} style={tailwind('h-18 w-18')} />
                        </View>
                        ...
                        <Marker
                            ...
                            <TouchableOpacity style={tailwind('flex items-center')}>
                                <View style={tailwind('flex items-center justify-center')}>
                                    <FastImage source={{ uri: getUrl(storeLocation.getAttribute('store.logo_url')) }} style={tailwind('h-8 w-8')} />
                                </View>
