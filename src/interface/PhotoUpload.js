...
import { View, Text, Image, StyleSheet, TouchableOpacity, Platform, Appearance, Dimensions, Alert } from 'react-native';
...
const PhotoUpload = (props) => {
    ...
    const onSelectPhoto = async (response) => {
        ...
        if (response.canceled && typeof props.onCancel === 'function') {
