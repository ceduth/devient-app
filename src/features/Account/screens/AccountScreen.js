...
const AccountScreen = ({ navigation, route }) => {
    ...
    const RenderBackground = (props) => {
        if (customer) {
            return (
                <ImageBackground
                    source={{ uri: getUrl(config('ui.accountScreen.signedInContainerBackgroundImage'))}}
        ...
        return (
            <ImageBackground
                source={{ uri: getUrl(config('ui.accountScreen.signedOutContainerBackgroundImage'))}}
                        ...
                        <View style={tailwind('p-4 mb-4 bg-white relative')}>
                            <View style={tailwind('flex flex-row')}>
                                <View style={tailwind('mr-4')}>
                                    <FastImage source={{ uri: getUrl(customer.getAttribute('photo_url')) }} style={tailwind('w-12 h-12 rounded-full')} />
                                </View>
                                <View>
