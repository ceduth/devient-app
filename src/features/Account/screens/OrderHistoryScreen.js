...
import { useCustomer, useLocale, useMountedState, useStorefront, useFleetbase, useFilesystem } from 'hooks';
                                ...
                                <View style={tailwind('flex flex-row justify-between flex-shrink-0 flex-grow-0')}>
                                    <View style={[tailwind('flex flex-row pr-8 flex-shrink-0'), { maxWidth: 225 }]}>
                                        <View style={tailwind('mr-3')}>
                                            <FastImage source={{ uri: getUrl(info.logo_url )}} style={tailwind('w-10 h-10')} />
                                        </View>
