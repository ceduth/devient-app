...
import { useCart, useLocale, useMountedState, useFilesystem } from 'hooks';
                ...
                <View style={tailwind('flex flex-row items-start')}>
                    ...
                    <View style={tailwind('flex flex-row items-start')}>
                        <View style={tailwind('mr-3')}>
                            <View>
                                <FastImage source={{ uri: getUrl(item.product_image_url) }} style={tailwind('w-16 h-16')} />
                            </View>
                        </View>
                                    ...
                                    <TouchableOpacity onPress={() => navigation.navigate('StoreScreen', { data: item.serialize() })} style={tailwind('flex flex-row items-center')}>
                                        <View style={tailwind('mr-3')}>
                                            <View style={tailwind('border border-white rounded-md')}>
                                                <FastImage source={{ uri: getUrl(item.getAttribute('logo_url')) }} style={tailwind('h-10 w-10 rounded-md')} />
                                            </View>
                                        </View>
